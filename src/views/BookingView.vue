        ...
        <div class="flex flex-wrap w-full space-x-0 ">
         ...
         <div data-aos="slide-up"  class="aos-init w-full md:w-1/3 my-5 md:my-auto ">
                <div class="text-lg  text-center  text-gray-100 bg-zinc-900 p-5 md:mt-2 rounded-lg md:rounded-xl  space-y-4">
                    ...
                    <br>
                    <p  class="text-lg  text-center  font-semibold flex justify-center mt-2 space-x-2 ">
                        <a href="https://instagram.com/shisha_table11?igshid=YmMyMTA2M2Y=" class="text-primary hover:text-slate-800 dark:hover:text-secondary">
                        ...
                        <a href="https://www.facebook.com/profile.php?id=100087177387934" class="text-primary hover:text-slate-800 dark:hover:text-secondary">
...
<!-- component -->
<div data-aos="zoom-in" class="aos-ini text-gray-600 body-font relative h-64">
    <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2485.393126332781!2d-0.3601846999999999!3d51.4692979!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x48760d3ca8eed589%3A0x9eed07bd8fb2aecd!2sTable%2011!5e0!3m2!1sen!2sse!4v1689243927693!5m2!1sen!2sse" width="100%" height="100%" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
</div>
    </div>
</template>

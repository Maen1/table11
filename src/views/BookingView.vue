    ...
    <div class="booking relative m-2 md:m-4">
        ...
        <div class="flex flex-wrap w-full">
         ...
         <div data-aos="slide-up"  class="aos-init w-full md:w-1/3 ">
                <p class="text-lg  text-center  text-gray-100 bg-slate-800 p-5 md:mt-2 rounded-lg md:rounded-xl ">
                    ...
                    <br>
                    <span class="text-lg font-semibold  text-center mt-4  text-primary bg-slate-800">
                    Everyday from 12 to 12
                    </span>
                    <br>
                    <span  class="text-lg  text-center  font-semibold flex justify-center mt-2 space-x-2 ">

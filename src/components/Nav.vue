...
<template>
    <div class="sticky top-0  z-50">
        <nav
            class="relative mb-2 mx-w-full flex flex-wrap items-center justify-between  bg-zinc-900 text-gray-200 shadow-lg navbar navbar-expand-lg navbar-light py-3"
            >
            ...
            <div class="container-fluid w-full flex flex-wrap items-center justify-between px-6">
                ...
                <div  class="md:hidden flex space-x-6 sm:justify-center ">
                    <a href="https://instagram.com/shisha_table11?igshid=YmMyMTA2M2Y=" class="text-primary hover:text-slate-800 dark:hover:text-amber-500">
                    ...
                    <a href="https://www.facebook.com/profile.php?id=100087177387934" class="text-primary hover:text-slate-800 dark:hover:text-amber-500">
